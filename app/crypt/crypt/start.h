...
#
# Example: Dpdl startup script for dpdl sample app 'DpdlSimpleCryptApp' that implements encryption and decryption of strings
#			using the tinycrypt C library
#
# Author: A.Costa
# e-mail: ac@dpdl.io
#
...
println("testing encryption/decryption of strings of data using the 'tinycrypt' C library...")

println("")

object simple_crypt = loadCode("app/crypt/dpdlSimpleCryptApp.h")

string msg = "This is my message to encrypt:)"
